...
public class TowerPooling : MonoBehaviour {
	...
	IEnumerator shoot()
	{
        ...
        {
            TowerBulletPooling bullet = BulletSpawnPooling.instance.pool.Get();
            bullet.transform.position = shootElement.position;
            bullet.GetComponent<TowerBulletPooling>().target = target;
            bullet.GetComponent<TowerBulletPooling>().twr = this;
            bullet.gameObject.SetActive(true);
            //GameObject b = GameObject.Instantiate(bullet, shootElement.position, Quaternion.identity) as GameObject; //Old code instantiate 
            /*
            TowerBulletPooling b = Instantiate(bullet, shootElement.position, Quaternion.identity);
            b.GetComponent<TowerBulletPooling>().target = target;
            b.GetComponent<TowerBulletPooling>().twr = this;
            */
